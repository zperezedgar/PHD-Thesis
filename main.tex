...
where the angular frequency is proportional to the energy according to the Planck relation 
...
Before proceeding with the computation of the phase, we need to establish the proportionality constant in Eq. \ref{planck_relation}. We will provide a justification lately, when analyzing the expansion of a free wave packet, that the correct proportionality constant is actually $1/2$, thereupon, the energy of the atomic wave packet will be given by

\begin{equation}\label{planck_relation_with_proportionality_constant}
E = \frac{1}{2} \hbar \omega, 
\end{equation}

Therefore, the accumulated phase will be given by

\begin{equation}\label{semi_classical_phase}
\Phi = \frac{C_{\pm}}{2\hbar} \int_{t_{0}}^{t} z(\ce{^{}_{}t{'}_{}})d\ce{^{}_{}t{'}_{}}
\end{equation}
...
\Phi_{1, T_{1}} = \frac{C_{-}}{2\hbar} \int_{0}^{T} (z_{0}+v_{0}t+a_{+} \frac{t^{2}}{2})dt
\end{equation}

\begin{equation}
\Phi_{2, T_{1}} = \frac{C_{+}}{2\hbar} \int_{0}^{T} (z_{0}+v_{0}t+a_{-} \frac{t^{2}}{2})dt
\end{equation}
...
\begin{equation}
\Phi_{1, T_{2}} = \frac{C_{+}}{2\hbar} \int_{0}^{2T} [(z_{0}+v_{0}T+a_{+} \frac{T^{2}}{2}) + (v_{0}+a_{+}T)t + a_{-} \frac{t^{2}}{2}]dt
\end{equation}

\begin{equation}
\Phi_{2, T_{2}} = \frac{C_{-}}{2\hbar} \int_{0}^{2T} [(z_{0}+v_{0}T+a_{-} \frac{T^{2}}{2}) + (v_{0}+a_{-}T)t + a_{+} \frac{t^{2}}{2}]dt
\end{equation}
...
\begin{equation}
\Phi_{1, T_{3}} = \frac{C_{-}}{2\hbar} \int_{0}^{T} [((z_{0}+v_{0}T+a_{+} \frac{T^{2}}{2}) + (v_{0}+a_{+}T)(2T) + a_{-} \frac{(2T)^{2}}{2}) + (v_{0}+a_{+}T + a_{-}(2T))t + a_{+} \frac{t^{2}}{2}]dt
\end{equation}

\begin{equation}
\Phi_{2, T_{3}} = \frac{C_{+}}{2\hbar} \int_{0}^{T} [((z_{0}+v_{0}T+a_{-} \frac{T^{2}}{2}) + (v_{0}+a_{-}T)(2T) + a_{+} \frac{(2T)^{2}}{2}) + (v_{0}+a_{-}T + a_{+}(2T))t + a_{-} \frac{t^{2}}{2}]dt
\end{equation}
...
\begin{equation}
\Delta \Phi = \Delta \Phi_{T_{1}} + \Delta \Phi_{T_{2}} + \Delta \Phi_{T_{3}} = 4 \frac{mga_{m}T^3}{\hbar}
\end{equation}

\begin{equation}\label{gravimetry_signal}
\Delta \Phi = 4 \frac{\mu \eta}{\hbar} g T^3
\end{equation}
...
Therefore, since $\Delta W q_{1}$ can be interpreted as the angular frequency of the alkali wave packet, where $\Delta W$ has units of $s^-1$, the energy related to this angular frequency is given by

\begin{equation}
    E = \hbar \frac{\Delta W}{2} 
\end{equation}

Thereby, we see that the correct proportionality factor in Eq. \ref{planck_relation} was in fact $1/2$ just as we stated in Eq. \ref{planck_relation_with_proportionality_constant}.
