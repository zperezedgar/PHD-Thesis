...
\subsection{Semi-classical Proof of the Condition for Atomic Interference}

In this section, we review the condition needed to generate atomic interference in a gravimeter within a magnetic gradient. Consider a transition between two hyperfine levels within a magnetic gradient of the following form

\begin{equation}
B = \eta z \hat{\textbf{z}}\
\end{equation}

Let $a_m$ be the acceleration due to the magnetic gradient for the hyperfine state $\ket{1}$ and $-a_m$ the acceleration for the hyperfine state\footnote{I am using a notation just to distinguish between the two hyperfine levels of interest. This notation does not tell you anything about the angular momentum or magnetic moment numbers except that they do not represent the same state and that we can consider transitions between them.} $\ket{2}$. Thus, the total accelerations for state $\ket{1}$ and state $\ket{2}$ are respectively
...
\subsubsection*{Sequence of pulses $\frac{\pi}{2} - \pi - \frac{\pi}{2}$}
...
From the condition on the final velocities, we get that in order to get interference, the acceleration $a_{1}$ must equal $a_{2}$ or alternatively, $T_{1}$ must equal $T_{2}$. Since, by assumption $a_{1}$ and $a_{2}$ cannot be the same, the only acceptable condition is $T_{1}=T_{2}$. By accepting this condition on the duration of the pulses and by demanding the condition on the final positions, we recover the unacceptable condition $a_{1}=a_{2}$. Therefore, we cannot produce interference within a magnetic field by applying just one $\pi$-pulse between the $\frac{\pi}{2}$ pulses.

\subsubsection*{Sequence of pulses $\frac{\pi}{2} - \pi - \pi - \frac{\pi}{2}$}

In this case, the equations for the final velocities are
...
These equations hold independently of the values for $a_{1}$ and $a_{2}$, as can be shown by substituting them into Eqs. (\ref{final_v1} and \ref{final_v2}). Therefore, the condition to get interference is to apply a 
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{posicion.png}
\caption{\label{fig:frog}This frog was uploaded via the file-tree menu.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{velocidad.png}
\caption{\label{fig:frog}This frog was uploaded via the file-tree menu.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{fase.png}
\caption{\label{fig:frog}This frog was uploaded via the file-tree menu.}
\end{figure}
