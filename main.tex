...
Therefore, the approximation in Eq.\ref{sigma_zero_approx} (and discarding the term that does not contribute at all) allows us to approximate the phase (Eq.\ref{quantum_phase}) as
...
\textcolor{blue}{The interpretation of the approximation in Eq.\ref{sigma_zero_approx} is that the initial wave packet has to have a wide spread.????}
...
(\textcolor{red}{en momento no existe ensanchamiento y el resultado concuerda con el semiclasico, en posición solo concuerda si ignoramos el ensanchamiento, parece que los terminos de ensanchamiento son el problema, , entonces debemos ignorar estos terminos de ensanchamiento?.})
