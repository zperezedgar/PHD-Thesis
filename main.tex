...
\begin{equation}\label{time_minimizes_final_width}
    t^{\ast}  = \frac{2M}{\hbar} {\Delta Z_{0}}^{2}.
\end{equation}
...
\begin{equation}\label{width_evaluated_t_min}
   (\Delta Z(t))_{min} = \Delta Z(t^{\ast}) = \kappa \sqrt{2}\Delta Z_{0}.
\end{equation}

Then, the rate of change between the initial width and the final width will given by

\begin{equation}
    \frac{\Delta Z_{0}}{\Delta Z(t^{\ast})} = \frac{1}{\kappa \sqrt{2}}.
\end{equation}
...
\begin{equation}
    \frac{\Delta Z_{0}}{\Delta Z(t^{\ast})} \approx 3.45
\end{equation}
...
\begin{equation}\label{width_evaluated_t_min_rabi}
    \Delta Z(t^{\ast}) = \kappa \sqrt{6} \Omega_{0} \frac{\hbar}{\mu_{B} g_{F} m_{F} \eta} \approx \frac{\sqrt{6} \Omega_{0}}{m_{F} \Delta W},
\end{equation}
...
\begin{equation}\label{expansion_wave_packet_time_solution}
    t = \frac{\Delta Z_{0}}{\xi} \sqrt{\bigg(\frac{\Delta Z_{f}}{\kappa}\bigg)^2 - (\Delta Z_{0})^2},
\end{equation}
...
\begin{equation}
    (\Delta Z_{0})^{\ast} = \frac{1}{\sqrt{2}} \frac{\Delta Z_{f}}{\kappa}
\end{equation}
...
\begin{equation}
    t_{max} = \frac{M}{\hbar} \bigg(\frac{\Delta Z_{f}}{\kappa}\bigg)^2
\end{equation}
...
\begin{tabular}{||c | c | c | c | c||} 
 ...
 \hline
 $\Delta Z(t)$ & $\Delta Z_{0}$ & $t$ & $t^{\ast} = \frac{2M}{\hbar} (\Delta Z_{0})^{2}$ & $(\Delta Z(t))_{min} = \kappa \sqrt{2} \Delta Z_{0}$ \\
 \hline
 $t$ & $\Delta Z_{f}$ & $\Delta Z_{0}$ & $(\Delta Z_{0})^{\ast} = \frac{1}{\sqrt{2}} \frac{\Delta Z_{f}}{\kappa}$ & $t_{max} = \frac{M}{\hbar} \bigg(\frac{\Delta Z_{f}}{\kappa}\bigg)^{2}$ \\
 \hline
...
\begin{equation}
    \Delta Z(t^{\ast}) = \sqrt{3} \Omega_{2} \frac{\hbar}{\mu_{B} g_{F} m_{F} \eta}
\end{equation}
