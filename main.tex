...
\textcolor{blue}{escribir forma matematica de la gaussiana propuesta en la fig 4. como funcion z (espacio de posicion)}
...
Furthermore, we will take the probability of transition for positions $|z| \ge 2 Z_{HWHM}$ to be zero. This approximation and the exact form of the transition probability versus the detuning can be seen in the Fig. \ref{ce2_VS_detuning}. \textcolor{blue}{(Proponer gaussiana en lugar de fig 5.b, escribirla en terminos de la desintonia usando eq. 123 para escribir la gaussiana en terminos del detuning (usar la gaussiana propuesta en fig 4). Sobreponer ambas graficas en una sola, eje y es probabilidad y el eje x es desintonia)}
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.9\textwidth}
         ...
         \caption{Approximation used to compute the detuning at $z= 2z_{HWHM}$ (Eq. \ref{detuning_condition}) and therefore the initial width of the atomic wave function (Eqs. \ref{width_zhwhm} and  \ref{position_at_zhwhm}). In this approximation the probability of finding the atom in the excited state is zero for positions $|z| \ge 2Z_{HWHM}$.}
...
We can use the Eq. \ref{detuning_condition} to determine the detuning at $z=2Z_{HWHM}$, i.e.,
...
\begin{equation}
\Omega = \frac{- e \textbf{B} \cdot \bra{e} \textbf{r} \ket{g}}{\hbar},
\end{equation}
