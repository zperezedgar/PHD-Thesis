...
\begin{tabular}{||c | c||} 
 ...
 \hline
 $\sigma_{z}(0) = \sqrt{2 \alpha}$ & $\sigma_{x}(0)$ \\
 \hline
 $4 \beta = 4 \Big(\frac{\partial^2 \omega(k)}{\partial k^2}\Big)_{k=k_{0}}$ & $\epsilon$ \\
 \hline
 $\upsilon_{g} = \Big(\frac{\partial \omega(k)}{\partial k}\Big)_{k=k_{0}}$ & $2 \rho_{0} \epsilon$ \\ [1ex] 
 \hline
\end{tabular}
\end{center}
...
\begin{tabular}{||c | c||} 
 ...
 Free wave packet & Alkali wave packet \\ [0.5ex] 
 \hline\hline
 $k_{0}z$ & $\left[\frac{\sigma_{x}(0)}{\sigma_{x}(\tau)} \right]^{2} \rho_{0}x$ \\ [1ex] 
 \hline
\end{tabular}
\end{center}
